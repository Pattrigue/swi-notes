...
\termdef{Keystones}{What we used to build the Solution - technologies, components, information, and human resources are examples of keystones.}
...
\termdef{Strategy}{Row in the Configuration Table. The master plan for solving the overall problem: Including the scope of the problem, the key components for building the solution, and the qualifications regarding limitations and constraints that may affect the utility or acceptability of a solution.}
